	...
	<script>
		$(function(){
			$('#form').validate({
				...
				rules:{
					id:{ required : true, rangelength : [4,16], remote : 'idcheck.do?' },
					pw:{ required : true, rangelength : [8,16] },
					pw1:{ required : true, rangelength : [8,16], equalTo : pw },
					name:{ required : true },
				...
				messages:{
					id:{required : '&nbsp&nbsp&nbsp'+'필수입력항목 입니다',
						rangelength : '&nbsp&nbsp&nbsp'+'아이디는 4~16자리로 입력가능합니다',
						remote : 'idcheck.do?'},
					pw:{required : '&nbsp&nbsp&nbsp'+'필수입력항목 입니다',
						rangelength : '&nbsp&nbsp&nbsp'+'비밀번호는8~16자리로 입력가능합니다'},
					pw1:{required :'&nbsp&nbsp&nbsp'+'필수입력항목 입니다',
						rangelength : '&nbsp&nbsp&nbsp'+'비밀번호는8~16자리로 입력가능합니다',
